...
public class UtilPlayerPrefs
{
    ...
    static UtilPlayerPrefs()
    {        
        byte[] saltBytes = new byte[] { 42, 23, 16, 21, 48, 87, 96, 53 };
        
        string randomSeedForKey = "cinamongames";

        string randomSeedForValue = "defensealone";
