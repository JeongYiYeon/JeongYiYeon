...
//////////////////////안되면 Yeon 에게 문의주세요///////////////////////
    ...
    public class DataQuest
    {
        ...
        [JsonProperty("EnumQuest.EQuest")]
        public EnumQuest.EQuest EQuest { get; set; }
        public int QUEST_GROUP { get; set; }
        public int QUEST_STEP { get; set; }
        public string QUEST_TYPE { get; set; }
        public int QUEST_COUNT { get; set; }
        public int QUEST_VALUE { get; set; }
